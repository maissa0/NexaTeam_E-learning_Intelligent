                    ...
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                        ...
                        <form [formGroup]="loginForm" (ngSubmit)="onSubmit()">
                            <div>
                                ...
                                <input pInputText id="username" type="text" placeholder="Username" class="w-full md:w-[30rem] mb-4" formControlName="username" />
                                <small *ngIf="loginForm.get('username')?.invalid && loginForm.get('username')?.touched" class="text-red-500 block mb-4">
                                ...
                                <small *ngIf="loginForm.get('password')?.invalid && loginForm.get('password')?.touched" class="text-red-500 block mb-4">
                                    Password is required
                                </small>

                                <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                                    <div class="flex items-center">
                                        <p-checkbox formControlName="rememberMe" id="rememberme1" [binary]="true" class="mr-2"></p-checkbox>
                                ...
                                <p-button type="submit" label="Sign In" styleClass="w-full" [disabled]="loginForm.invalid || isLoading"></p-button>
                                
                                <div class="text-center mt-4">
                                    <span class="text-surface-900 dark:text-surface-0">Don't have an account?</span>
                                    <a routerLink="/auth/register" class="font-medium no-underline ml-2 text-primary cursor-pointer">Sign Up</a>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                next: (response) => {
                    ...
                    if (response.is2faEnabled) {
                        this.router.navigate(['/auth/verify-two-factor'], { 
                            queryParams: { token: response.jwtToken } 
                        });
                    } else {
