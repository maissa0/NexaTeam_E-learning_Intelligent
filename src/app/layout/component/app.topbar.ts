        ...
        <div class="layout-topbar-actions">
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <button *ngIf="isAdmin" type="button" class="layout-topbar-action" routerLink="/admin/company-requests">
                        <i class="pi pi-building"></i>
                        <span>Company Requests</span>
                    </button>
                    <button *ngIf="isAdmin" type="button" class="layout-topbar-action" routerLink="/admin/company-dashboard">
    ...
    checkAdminRole() {
        ...
        if (token) {
            this.authService.getUserProfile().subscribe({
                next: (response) => {
                    if (response.user?.role?.roleName === 'ROLE_ADMIN') {
                        this.isAdmin = true;
                    }
                },
                error: () => {
