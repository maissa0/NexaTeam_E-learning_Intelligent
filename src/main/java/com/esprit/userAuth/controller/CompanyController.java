...
public class CompanyController {
    ...
    public ResponseEntity<List<Company>> getAllCompanies() {
        ...
        companies.forEach(company -> {
            // Either set to null or create a new empty list
    ...
    /**
     * Admin endpoint to get employees of a specific company
     */
    @GetMapping("/admin/{id}/employees")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<?> getCompanyEmployees(@PathVariable Long id) {
        return companyService.getCompanyById(id)
                .map(company -> {
